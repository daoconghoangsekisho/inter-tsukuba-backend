...
namespace Src\Agenda\MatchResult\Application\Mappers;

use Illuminate\Http\Request;
use Src\Agenda\MatchResult\Domain\Model\MatchResult;
...
class MatchResultMapper extends Mapper
{
    public static function fromRequest(Request $request, ?int $company_id = null): MatchResult
    {
